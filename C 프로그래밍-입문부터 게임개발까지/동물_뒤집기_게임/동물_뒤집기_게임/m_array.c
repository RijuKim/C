...
int getEmptyPosition() {
	...
	while (1) {
		...
		if (arrayAnimal[x][y] == -1) { //초기 -1로 설정했기 때문에 -1일 경우 빈 공간
			return randPos;//반복작업을 안 하려면 구조체로도 정의 가능
		}
	}
	return 0;
}
